...
function MailHtml(host) {
    const { html, errors } = mjmlReact.render(
        <mjmlReact.Mjml>
          <mjmlReact.MjmlHead>
            <mjmlReact.MjmlFont name="Barlow" href="https://fonts.googleapis.com/css2?family=Barlow:wght@500;700;800&display=swap" />
            ...
            <mjmlReact.MjmlWrapper padding="40px 15px">
              <mjmlReact.MjmlSection background-color="#fff" border-radius="25px">
                <mjmlReact.MjmlColumn>
                  <mjmlReact.MjmlText css-class="apple-link-black" font-size="20px" font-family="Barlow" font-weight="800">
                    <a href="#">
                      {host}
                    </a>
                  </mjmlReact.MjmlText>
                  <mjmlReact.MjmlText font-size="40px" font-weight="800" font-family="Barlow">
                  ...
                  <mjmlReact.MjmlImage src={`${host}/images/mail/immobilie-registrieren.png`} />
                  <mjmlReact.MjmlImage src={`${host}/images/mail/öffentliche-daten-finden.png`} />
                  <mjmlReact.MjmlImage src={`${host}/images/mail/gebäudeanalyse-freischalten.png`} />
                </mjmlReact.MjmlColumn>
              </mjmlReact.MjmlSection>
              <mjmlReact.MjmlSection full-width="full-width" text-align="left" padding="15px 0px 0px 0px">
                <mjmlReact.MjmlColumn padding="0px">
                  <mjmlReact.MjmlText align="left" font-size="15px" font-weight="500" font-family="Barlow">
